...
COCO_ROOT = "/workspace/I/liuzisheng/ssd.pytorch-master/data/coco/coco2017"
ANNOTATIONS = 'annotations'
COCO_API = "/datasets/coco/cocoAPI"
...
class COCOAnnotationTransform(object):
    ...
    """
    def __init__(self):
        self.label_map = get_label_map('./data/coco/coco_labels.txt')
...
class COCODetection(data.Dataset):
    ...
    def pull_item(self, index):
        ...
        #print(f"Original image shape: {img.shape}")  # 添加调试信息
        ...
        if self.transform is not None:
            ...
            # to rgb
            img = img[:, :, (2, 1, 0)]
            #print(f"Transformed image shape: {img.shape}")  # 添加调试信息
